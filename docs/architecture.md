...
Main._Process (round live + settled) → every 4–8s → TriggerAmbientRustle → epicenter + closest ≤6 at-rest pieces shiver along a shared draft (Debris.Rustle, sprite-only wiggle)
```
